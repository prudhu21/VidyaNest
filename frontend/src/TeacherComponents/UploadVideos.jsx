            ...
            <div className="card">
              <div className="card-body p-4">
                <div className="d-flex align-items-center mb-4">
                  ...
                  <div>
                    <h3 className="card-title mb-1">Upload Video</h3>
                    <p className="text-muted mb-0">Share educational videos with students</p>
                  </div>
                </div>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mb-3">
                    <label htmlFor="video-file" className="form-label fw-medium">Video File (MP4 only)</label>
                    <input
                      type="file"
                      name="file"              
                      className="form-control"
