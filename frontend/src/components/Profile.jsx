...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    if (savedUserData) setFormData((prev) => ({ ...prev, ...savedUserData }));
  }, []);
    ...
    <Form noValidate validated={validated} onSubmit={handleSubmit}>
      <div className="d-flex">
        <div className="relative">
          ...
          />
          <div>
            <DropdownButton title={<PencilSquare />} className="edit-icon" id="dropdown-custom-1">
              <Dropdown.Item onClick={() =>document.getElementById("profileImageInput").click()}> Edit Profile Picture</Dropdown.Item>
              <Dropdown.Item onClick={handleDeleteImage}>Delete Profile Picture</Dropdown.Item>
            </DropdownButton>
          </div>
        ...
        <div>
          <h5 className="mt-5 pl-5 profile-txt mt-5">Edit Your Profile</h5>
        </div>
      </div>
